  ...
  (function(_PureComponent) {
    ...
    function Menu() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(Menu)).call.apply(_getPrototypeOf2, [this].concat(args)),
      );

      _defineProperty(_assertThisInitialized(_this), 'state', {});

      _defineProperty(_assertThisInitialized(_this), 'menuNode', createRef());

      _defineProperty(_assertThisInitialized(_this), 'handleDocumentClick', function(event) {
        if (
          _this.state.active &&
          !events.targetIsDescendant(event, ReactDOM.findDOMNode(_assertThisInitialized(_this)))
        ) {
          _this.hide();
        }
      });
      ...
      [
        ...
        },
        {
          ...
          value: function getItems() {
            ...
            var MenuItemType = React.createElement(MenuItem, null).type;
        ...
        },
        {
          ...
          value: function render() {
            ...
            var _this$props2 = this.props,
              ...
              others = _objectWithoutProperties(_this$props2, ['className', 'outline']);

            var classNames = cx(
              theme['menu'],
              theme[position],
              _defineProperty({}, theme['active'], active),
              className,
            );
            var outlineClassNames = cx(
              theme['outline'],
