...
import React, { ReactElement, ReactNode, forwardRef, useEffect, useState } from 'react';
...
const Toast: GenericComponent<ToastProps> = forwardRef<HTMLDivElement, ToastProps>(
  ({ children, className, label, processing, timeout, onTimeout, link, action, actionLabel, onClose }, ref) => {
