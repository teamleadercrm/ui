...
const Pagination: GenericComponent<PaginationProps> = forwardRef<HTMLElement, PaginationProps>(
  ({ className, currentPage = 1, maxNumPagesVisible = 7, numPages, children, ...others }, ref) => {
    if (numPages < 2) {
      return null;
    }
    ...
    return (
      <Box data-teamleader-ui="pagination" className={classNames} element="nav" {...others} ref={ref}>
