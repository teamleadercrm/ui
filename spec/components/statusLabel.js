      ...
      <article>
        ...
        <div className="component-spec">
          <div className="properties">
            ...
            <p>
              <StatusLabel color="neutral" size="small">
                Neutral
              </StatusLabel>
              <StatusLabel color="mint" size="small">
                Mint
              </StatusLabel>
              <StatusLabel color="aqua" size="small">
                Aqua
              </StatusLabel>
              <StatusLabel color="violet" size="small">
                Violet
              </StatusLabel>
              <StatusLabel color="gold" size="small">
                Gold
              </StatusLabel>
              <StatusLabel color="ruby" size="small">
                Ruby
              </StatusLabel>
            </p>
            ...
            <Heading2>
              I'm a Heading 2 with status label{' '}
              <StatusLabel color="mint" size="small">
                Teal
              </StatusLabel>
            </Heading2>
            ...
            <Heading3>
              I'm a Heading 3 with status label{' '}
              <StatusLabel color="aqua" size="small">
                Aqua
              </StatusLabel>
            </Heading3>
            ...
            <Heading4>
              I'm a Heading 4 with status label{' '}
              <StatusLabel color="violet" size="small">
                Violet
              </StatusLabel>
            </Heading4>
            ...
            <TextBody>
              I'm body text with status label{' '}
              <StatusLabel color="gold" size="small">
                Gold
              </StatusLabel>
            </TextBody>
            ...
            <TextSmall>
              I'm small text with status label{' '}
              <StatusLabel color="ruby" size="small">
                Ruby
              </StatusLabel>
            </TextSmall>
